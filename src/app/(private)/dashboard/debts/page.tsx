              ...
              <div className="space-y-3">
                {deliveries.map((delivery) => {
                  ...
                  return (
                    <div
                      key={delivery.code}
                      className="flex items-center justify-between p-4 rounded-xl border-2 border-gray-100 hover:border-blue-300 hover:shadow-lg transition-all duration-300 bg-white"
                    >
                      {/* Left: Icon and Info */}
                      <div className="flex items-center gap-4 flex-1">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-1">
                            ...
                            <Badge className={`${statusConfig.bgColor} ${statusConfig.color} border-2 ${statusConfig.borderColor}`}>
                              {statusConfig.label}
                            </Badge>
                          </div>
        ...
        {deliveries.length > 0 && (
          <div className="flex justify-center">
            <Button
              ...
              className="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white px-12 py-6 rounded-xl text-lg font-bold shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105"
            >
